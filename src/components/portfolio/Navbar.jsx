...
export default function Navbar({ doctor }) {
  ...
  const navBg = scrolled
    ? isDark
      ? "bg-[#0A110F]/90 backdrop-blur-md shadow-lg border-b border-[#1E3330]"
      : "bg-[#FDFCF8]/90 backdrop-blur-md shadow-sm border-b border-[#E2E8E4]"
    : "bg-transparent";
  ...
  return (
    <>
      ...
      {menuOpen && (
        <div
          className={`fixed inset-0 z-40 flex flex-col items-center justify-center gap-8 ${isDark ? "bg-[#0A110F]" : "bg-[#FDFCF8]"}`}
        >
          <button
